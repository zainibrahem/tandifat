...
<div class="wrapper xl:mt-8 relative z-10">
        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0 ">
                <div class="relative">
                    ...
                    <div
                        class="h-full absolute top-0  w-full text-white text-sm xl:text-5xl text-left flex flex-col justify-center items-start pl-20 xl:pl-48">
                        <div class="absolute bg-black top-0 left-0 opacity-50 h-full w-full z-10"></div>
                        <span class="relative text-xs xl:text-md z-20  font-bold">Consequat mattis.</span>
                        <span class="text-xxs xl:text-3xl relative z-20 w-10/12 xl:w-2/3 mt-1 xl:mt-4">Lorem ipsum dolor
                            sit amet, consectetur adipiscing
                            elit. Quam facilisis eget id amet nulla. Feugiat in.
                        </span>
                        <button
                            class="rounded-full relative z-20 text-white text-xxs xl:text-xl w-20 xl:w-36 mt-1 xl:mt-4 py-1 xl:py-2 bg-primary">TRY
                            IT</button>
                    </div>
                </div>
            </div>
    ...
    <div class="deals w-full py-20">
        <h1 class="text-center text-3xl xl:text-5xl text-blacks">Top Deals</h1>
    </div>
...
<div class="relative w-full grid grid-cols-12 gap-4 px-4 xl:px-12 mt-12">
    <div class="col-span-12 xl:col-span-6 px-6 xl:px-12 h-60 xl:h-96 bg-red-500 flex flex-col justify-end items-start"
    style="background:url({{asset('imgs/badges/left1.png')}});background-size:cover">
    <h1 class="text-xl xl:text-5xl font-bold text-white">
        Sale of 50 %
    </h1>
    <h1 class="text-md xl:text-2xl mt-8 text-white">
        <span class="text-md xl:text-3xl">236</span>DAYS : <span class="text-md xl:text-3xl">15</span>HRs : <span
            class="text-md xl:text-3xl">06</span>MINS : <span class="text-md xl:text-3xl">22</span>SECS
    </h1>
    <button class="border-2 text-2xl border-white mb-4 xl:mb-16 text-white h-14 w-48 mt-8 rounded-full">
        Order Now
    </button>
</div>
    <div class="col-span-12 xl:col-span-6 px-6 xl:px-12 h-60 xl:h-96 bg-red-500 flex flex-col justify-end items-start"
    ...
    <div x-data="setup()" class="w-full">
        <ul class="flex justify-center items-center my-4 ">
            <template x-for="(tab, index) in tabs" :key="index">
                <li class="cursor-pointer py-2 px-4 text-sm xl:text-2xl "
...
<div class="w-full flex flex-col justify-around items-start relative">
    <div class="relative">
        <img class="w-full" src="{{asset('imgs/slider/slide1.png')}}" alt="">
        <div class="absolute bg-black bg-opacity-60 h-full flex flex-col justify-around items-start xl:pl-12 pl-12 py-24 xl:py-24 w-full top-0 left-0">
            <h1 class="text-white text-sm xl:text-4xl">Proin enim.</h1>
            <h1 class="text-white text-xs xl:text-5xl mt-4 hidden xl:block" style="font-weight:700;letter-spacing:2rem">TITLE</h1>
            <h1 class="text-white text-xs xl:text-5xl mt-4 block xl:hidden" style="font-weight:700;letter-spacing:14px">TITLE</h1>
            <p class="text-white text-xxs xl:text-xl mt-4 " style="">Lorem Ipsum is simply dummy text of the printing </p>
            <p class="text-white text-xxs xl:text-xl mt-4 " style="">Lorem Ipsum is simply dummy text of the printing </p>
            <button class="bg-primary w-24 h-12 xl:w-96 xl:h-16 mt-4 text-white text-sm xl:text-3xl rounded-full">Order Now</button>
        </div>
    </div>
...
<div class="deals w-full py-20">
    <h1 class="text-center text-3xl xl:text-5xl text-blacks">Get To Know US</h1>
</div>
...
<div class="w-full p-10 xl:px-20 relative py-12 mt-64 flex flex-col xl:flex-row justify-between items-center"
    ...
    <div class="flex flex-col justify-center  items-center xl:items-end">
        <div class="relative w-80 xl:w-96 mt-8">
            <input type="text" class="bg-white rounded-full h-12 w-80 xl:w-96 pl-6" placeholder="Mobile Number">
            <button class="absolute right-0 bg-primary rounded-full text-white h-12 w-28 xl:w-40 text-center text-md xl:text-xl">Send
                Link</button>
        </div>
        <img class="hidden xl:block absolute w-72 left-1/2 transform -translate-x-1/3" src="{{asset('imgs/mobile.png')}}" alt="">
        <div class="flex px-12 xl:px-0 justify-between items-center w-96 mt-4">
            <img class="w-28 xl:w-44" src="{{asset('imgs/google.png')}}" alt="">
            <img class="w-24 xl:w-40" src="{{asset('imgs/apple.png')}}" alt="">
        </div>
    </div>
</div>

<div class="relative w-full grid grid-cols-12 gap-4 px-4 xl:px-12  mt-40 ">
...
<div class="deals w-full py-20">
    <h1 class="text-center text-3xl xl:text-5xl text-blacks">Grow With Tandifat</h1>
</div>

<div class="w-10/12 flex justify-center items-center relative left-1/2 transform -translate-x-1/2">
    <div class="grid grid-cols-12 gap-4 w-full relative">
        <div class="col-span-12 xl:col-span-3">
            <div class="bg-white p-4 flex flex-col justify-between items-center" style="border-radius:40px;">
...
<div class="footer px-2 xl:px-16 grid grid-cols-12 gap-2 pb-8 w-full pt-48 xl:pt-36"
    style="background: url({{asset('imgs/footer.png')}});background-size:cover">
    <div class="col-span-12 xl:col-span-4 flex flex-col justify-start items-start">
        <img src="{{asset('imgs/footerlogo.png')}}" class="w-72" alt="">
        <p class="text-white text-center xl:text-left text-sm -mt-4 leading-8" style="font-weight: 100">
            TANDIFAT is an online platform that regroups all
            Cleaning Services and Products in one marketplace. It
            has it all: An e commerce for products & booking of a
            service. (Laundry & Dry cleaning, Carpet Cleaning,
            Office Cleaning, Commercial Cleaning, Window
            Cleaning, Apart & Home Cleaning, Cleaners Experts.)
        </p>
    </div>

    <div class="col-span-12 xl:col-span-5 text-white pr-0 xl:pr-12 pl-0 xl:pl-12 flex flex-col justify-between items-start flex-wrap mt-12 xl:mt-28 ">
        <div class="grid grid-cols-12 w-full">
            <div class="col-span-6 flex flex-col justify-between items-start">
                <h1 class="text-sm xl:text-md font-normal"><span class="mr-6 text-2xl">></span> About</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Return Policy</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Seller Policy</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Cookies Policy</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Affiliate Partner</h1>
            </div>
            <div class="col-span-6 flex flex-col justify-between items-start">
                <h1 class="text-sm xl:text-md font-normal"><span class="mr-6 text-2xl">></span> Our Blog</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Terms & conditions</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Support</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Privacy Policy</h1>
                <h1 class="text-sm xl:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> Work With US</h1>
            </div>
        </div>


    </div>
    <div class="col-span-12 xl:col-span-3 flex flex-col justify-start items-center xl:items-start  pt-24">
        <h3 class="text-white text-center text-md font-bold">
            Subscribe our Newsletter
        </h3>
        <p class="text-white text-center xl:text-left font-light mt-2" style="font-size: 10px">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Risus
            malesuada pulvinar ultrices cursus nunc. Sed phasellus
            vestibulum sapien orci metus rhoncus quisque.
        </p>
        <div class="relative w-9/12 xl:w-full mt-4">
            <input type="text" class="bg-white rounded-full h-8 w-full xl:w-full pl-6" placeholder="Your Email">
            <button class="absolute right-0 bg-primary rounded-full text-white h-8 w-16 text-center text-sm"
                style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">Send</button>
        </div>
        <div class="w-9/12 xl:w-full flex justify-between items-center mt-4">
            <svg width="30" height="30" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                    <path
                        d="M24.1114 20.7437C24.1114 22.8831 22.3771 24.6174 20.2378 24.6174C18.0984 24.6174 16.3641 22.8831 16.3641 20.7437C16.3641 18.6044 18.0984 16.8701 20.2378 16.8701C22.3771 16.8701 24.1114 18.6044 24.1114 20.7437Z"
                        fill="#F2F2F2" />
                    <path
                        d="M29.2967 13.8906C29.1105 13.386 28.8134 12.9293 28.4274 12.5544C28.0525 12.1684 27.5961 11.8713 27.0912 11.6851C26.6817 11.5261 26.0666 11.3368 24.9336 11.2852C23.708 11.2293 23.3405 11.2173 20.2376 11.2173C17.1345 11.2173 16.767 11.229 15.5417 11.2849C14.4087 11.3368 13.7932 11.5261 13.3841 11.6851C12.8792 11.8713 12.4225 12.1684 12.0479 12.5544C11.6619 12.9293 11.3648 13.3857 11.1783 13.8906C11.0193 14.3001 10.83 14.9155 10.7784 16.0485C10.7225 17.2738 10.7104 17.6413 10.7104 20.7445C10.7104 23.8473 10.7225 24.2148 10.7784 25.4404C10.83 26.5734 11.0193 27.1886 11.1783 27.5981C11.3648 28.1029 11.6616 28.5594 12.0476 28.9342C12.4225 29.3202 12.8789 29.6173 13.3838 29.8035C13.7932 29.9629 14.4087 30.1522 15.5417 30.2037C16.767 30.2596 17.1342 30.2714 20.2373 30.2714C23.3408 30.2714 23.7083 30.2596 24.9333 30.2037C26.0663 30.1522 26.6817 29.9629 27.0912 29.8035C28.1047 29.4126 28.9058 28.6115 29.2967 27.5981C29.4557 27.1886 29.645 26.5734 29.6969 25.4404C29.7528 24.2148 29.7645 23.8473 29.7645 20.7445C29.7645 17.6413 29.7528 17.2738 29.6969 16.0485C29.6453 14.9155 29.456 14.3001 29.2967 13.8906ZM20.2376 26.7115C16.9418 26.7115 14.27 24.04 14.27 20.7442C14.27 17.4483 16.9418 14.7769 20.2376 14.7769C23.5332 14.7769 26.205 17.4483 26.205 20.7442C26.205 24.04 23.5332 26.7115 20.2376 26.7115ZM26.4409 15.9355C25.6707 15.9355 25.0463 15.3111 25.0463 14.5409C25.0463 13.7708 25.6707 13.1464 26.4409 13.1464C27.211 13.1464 27.8354 13.7708 27.8354 14.5409C27.8351 15.3111 27.211 15.9355 26.4409 15.9355Z"
                        fill="#F2F2F2" />
                    <path
                        d="M20.2377 0.506348C9.06245 0.506348 0 9.5688 0 20.7441C0 31.9194 9.06245 40.9818 20.2377 40.9818C31.413 40.9818 40.4755 31.9194 40.4755 20.7441C40.4755 9.5688 31.413 0.506348 20.2377 0.506348ZM31.7885 25.5352C31.7323 26.7722 31.5356 27.6168 31.2484 28.3561C30.6447 29.9171 29.4107 31.1511 27.8497 31.7548C27.1108 32.0419 26.2659 32.2383 25.0291 32.2949C23.7899 32.3514 23.394 32.365 20.238 32.365C17.0818 32.365 16.6862 32.3514 15.4466 32.2949C14.2099 32.2383 13.365 32.0419 12.626 31.7548C11.8503 31.4629 11.1481 31.0056 10.5676 30.4142C9.97651 29.834 9.51917 29.1315 9.22735 28.3561C8.94016 27.6171 8.74345 26.7722 8.68725 25.5355C8.63012 24.2959 8.61684 23.9 8.61684 20.7441C8.61684 17.5881 8.63012 17.1922 8.68694 15.953C8.74314 14.7159 8.93954 13.8714 9.22673 13.1321C9.51855 12.3567 9.9762 11.6541 10.5676 11.0739C11.1478 10.4825 11.8503 10.0252 12.6257 9.73339C13.365 9.4462 14.2096 9.2498 15.4466 9.19329C16.6859 9.13678 17.0818 9.12319 20.2377 9.12319C23.3937 9.12319 23.7896 9.13678 25.0288 9.1936C26.2659 9.2498 27.1105 9.4462 27.8497 9.73308C28.6251 10.0249 29.3277 10.4825 29.9082 11.0739C30.4993 11.6545 30.9569 12.3567 31.2484 13.1321C31.5359 13.8714 31.7323 14.7159 31.7888 15.953C31.8453 17.1922 31.8586 17.5881 31.8586 20.7441C31.8586 23.9 31.8453 24.2959 31.7885 25.5352Z"
                        fill="#F2F2F2" />
                </g>
                <defs>
                    <clipPath id="clip0">
                        <rect width="40.4755" height="40.4755" fill="white" transform="translate(0 0.506348)" />
                    </clipPath>
                </defs>
            </svg>
            <svg width="30" height="30" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                    <path
                        d="M40.9509 20.7441C40.9509 9.56589 31.8914 0.506348 20.7132 0.506348C9.53501 0.506348 0.475464 9.56589 0.475464 20.7441C0.475464 31.9223 9.53501 40.9818 20.7132 40.9818C20.8318 40.9818 20.9504 40.9818 21.0689 40.9739V25.2264H16.721V20.1591H21.0689V16.4277C21.0689 12.1035 23.7093 9.74772 27.5671 9.74772C29.417 9.74772 31.006 9.88211 31.4645 9.94535V14.4672H28.8083C26.7134 14.4672 26.3023 15.4633 26.3023 16.9258V20.1512H31.3222L30.666 25.2185H26.3023V40.1992C34.761 37.7722 40.9509 29.9854 40.9509 20.7441Z"
                        fill="#F2F2F2" />
                </g>
                <defs>
                    <clipPath id="clip0">
                        <rect width="40.4755" height="40.4755" fill="white" transform="translate(0.475464 0.506348)" />
                    </clipPath>
                </defs>
            </svg>
            <svg width="30" height="30" viewBox="0 0 42 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                    <path d="M18.6678 24.5356L25.2509 20.7441L18.6678 16.9526V24.5356Z" fill="#F2F2F2" />
                    <path
                        d="M21.1887 0.506348C10.0134 0.506348 0.950928 9.5688 0.950928 20.7441C0.950928 31.9194 10.0134 40.9818 21.1887 40.9818C32.3639 40.9818 41.4264 31.9194 41.4264 20.7441C41.4264 9.5688 32.3639 0.506348 21.1887 0.506348ZM33.8341 20.7648C33.8341 20.7648 33.8341 24.8691 33.3135 26.8482C33.0217 27.9315 32.1675 28.7856 31.0843 29.0771C29.1051 29.5981 21.1887 29.5981 21.1887 29.5981C21.1887 29.5981 13.2929 29.5981 11.2931 29.0564C10.2098 28.7649 9.35562 27.9105 9.06381 26.8272C8.54285 24.8691 8.54285 20.7441 8.54285 20.7441C8.54285 20.7441 8.54285 16.6401 9.06381 14.661C9.35532 13.5777 10.2305 12.7025 11.2931 12.411C13.2722 11.8901 21.1887 11.8901 21.1887 11.8901C21.1887 11.8901 29.1051 11.8901 31.0843 12.4317C32.1675 12.7232 33.0217 13.5777 33.3135 14.661C33.8551 16.6401 33.8341 20.7648 33.8341 20.7648Z"
                        fill="#F2F2F2" />
                </g>
                <defs>
                    <clipPath id="clip0">
                        <rect width="40.4755" height="40.4755" fill="white" transform="translate(0.950928 0.506348)" />
                    </clipPath>
                </defs>
            </svg>
            <svg width="30" height="30" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                    <path
                        d="M20.6641 0.506348C9.48884 0.506348 0.426392 9.5688 0.426392 20.7441C0.426392 31.9194 9.48884 40.9818 20.6641 40.9818C31.8394 40.9818 40.9018 31.9194 40.9018 20.7441C40.9018 9.5688 31.8394 0.506348 20.6641 0.506348ZM29.9044 16.2856C29.9134 16.4848 29.9177 16.6849 29.9177 16.8859C29.9177 23.024 25.2455 30.102 16.7012 30.1024H16.7016H16.7012C14.078 30.1024 11.6369 29.3334 9.58117 28.0158C9.94463 28.0587 10.3146 28.08 10.6892 28.08C12.8656 28.08 14.8685 27.3376 16.4585 26.0916C14.4251 26.0539 12.7106 24.711 12.1189 22.8652C12.4021 22.9196 12.6933 22.9492 12.9919 22.9492C13.4159 22.9492 13.8266 22.8921 14.2169 22.7856C12.0914 22.36 10.4903 20.4816 10.4903 18.2323C10.4903 18.2113 10.4903 18.1924 10.4909 18.173C11.1168 18.521 11.8327 18.7304 12.5948 18.7538C11.3475 17.9216 10.5277 16.499 10.5277 14.8873C10.5277 14.0363 10.7577 13.2389 11.1567 12.5525C13.4474 15.3632 16.8708 17.2117 20.7314 17.4059C20.6518 17.0656 20.6107 16.7111 20.6107 16.3467C20.6107 13.7824 22.6911 11.702 25.2563 11.702C26.5925 11.702 27.7993 12.2668 28.647 13.1697C29.7053 12.961 30.699 12.5744 31.5967 12.0423C31.2493 13.1265 30.5131 14.0363 29.5539 14.6116C30.4936 14.4991 31.3892 14.2499 32.2214 13.88C31.5998 14.8117 30.8114 15.63 29.9044 16.2856Z"
                        fill="#F2F2F2" />
                </g>
                <defs>
                    <clipPath id="clip0">
                        <rect width="40.4755" height="40.4755" fill="white" transform="translate(0.426392 0.506348)" />
                    </clipPath>
                </defs>
            </svg>
            <svg width="30" height="30" viewBox="0 0 42 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0)">
                    <path
                        d="M21.1396 0.506348C9.9643 0.506348 0.901855 9.5688 0.901855 20.7441C0.901855 31.9194 9.9643 40.9818 21.1396 40.9818C32.3149 40.9818 41.3773 31.9194 41.3773 20.7441C41.3773 9.5688 32.3149 0.506348 21.1396 0.506348ZM33.2598 27.2783C33.114 27.618 32.4588 28.1007 30.1668 28.4546C29.9791 28.4833 29.9065 28.7276 29.7947 29.2393C29.754 29.4255 29.7129 29.6086 29.6564 29.801C29.6076 29.9677 29.5035 30.0458 29.3284 30.0458H29.3C29.1783 30.0458 29.006 30.0239 28.7871 29.981C28.3989 29.9053 27.9638 29.8355 27.4101 29.8355C27.0868 29.8355 26.7524 29.8633 26.4161 29.9189C25.7284 30.0338 25.1445 30.4457 24.5262 30.883C23.6279 31.5185 22.7006 32.1741 21.2551 32.1741C21.1921 32.1741 21.1306 32.172 21.0686 32.1692C21.029 32.1726 20.988 32.1741 20.9469 32.1741C19.502 32.1741 18.5747 31.5188 17.6779 30.8842C17.0587 30.447 16.4742 30.0338 15.7856 29.9189C15.4496 29.8633 15.1151 29.8355 14.7924 29.8355C14.2097 29.8355 13.7508 29.9254 13.4152 29.9909C13.2117 30.0307 13.0357 30.065 12.9019 30.065C12.7624 30.065 12.6114 30.0347 12.5456 29.8102C12.4885 29.6154 12.4474 29.4273 12.4072 29.2445C12.3047 28.7757 12.2322 28.4873 12.0358 28.4571C9.74413 28.1032 9.08792 27.6202 8.94186 27.2777C8.92147 27.2289 8.90912 27.1795 8.90665 27.1314C8.89924 26.9995 8.99219 26.8831 9.12251 26.8621C12.645 26.2822 14.2249 22.6812 14.2906 22.5283C14.2922 22.5246 14.294 22.5203 14.2962 22.5163C14.5117 22.0793 14.5537 21.6998 14.4222 21.3889C14.1804 20.8194 13.3917 20.569 12.8698 20.4035C12.7423 20.3627 12.6212 20.3247 12.5255 20.2867C11.4839 19.8751 11.3975 19.4527 11.4385 19.2374C11.5083 18.8703 11.9987 18.6143 12.3955 18.6143C12.5039 18.6143 12.5996 18.6337 12.6802 18.6714C13.149 18.8906 13.5711 19.0021 13.9358 19.0021C14.4392 19.0021 14.659 18.7906 14.6859 18.7628C14.6726 18.5244 14.6569 18.2752 14.6408 18.018C14.5358 16.3529 14.4055 14.283 14.9329 13.1018C16.5122 9.56108 19.8608 9.28562 20.8499 9.28562C20.8752 9.28562 21.2835 9.2813 21.2835 9.2813H21.3418C22.3328 9.2813 25.6895 9.55675 27.2693 13.0997C27.7965 14.2814 27.6661 16.3529 27.5611 18.017L27.5565 18.0896C27.542 18.3212 27.5278 18.5463 27.5161 18.7622C27.5414 18.7881 27.7436 18.9824 28.1997 19H28.2001C28.5475 18.9867 28.9458 18.8758 29.3834 18.6714C29.5112 18.6112 29.6539 18.5985 29.7506 18.5985C29.8991 18.5985 30.0489 18.6275 30.1733 18.6791L30.1813 18.6825C30.5349 18.8079 30.7668 19.0555 30.7718 19.3149C30.7764 19.5589 30.5899 19.9257 29.6764 20.2867C29.5816 20.3241 29.4606 20.3624 29.3321 20.4032C28.8096 20.5687 28.0216 20.8194 27.7798 21.3885C27.6479 21.6998 27.6899 22.0787 27.9058 22.5157C27.9076 22.52 27.9098 22.524 27.9116 22.5283C27.9771 22.6812 29.5551 26.2809 33.0798 26.8618C33.2098 26.8831 33.303 26.9995 33.2956 27.1307C33.2928 27.1802 33.2808 27.2299 33.2598 27.2783Z"
                        fill="#F2F2F2" />
                </g>
                <defs>
                    <clipPath id="clip0">
                        <rect width="40.4755" height="40.4755" fill="white" transform="translate(0.901855 0.506348)" />
                    </clipPath>
                </defs>
            </svg>
        </div>
        <div class="w-9/12 xl:w-full mt-4 flex justify-between items-center">
            <img class="w-12" src="{{asset('imgs/payment/express.png')}}" alt="">
            <img class="w-16" src="{{asset('imgs/payment/visa.png')}}" alt="">
            <img class="w-16" src="{{asset('imgs/payment/mastercard.png')}}" alt="">
        </div>
    </div>
</div>

<div class="copyright w-full py-1 bg-carousel flex justify-center items-center">
    <h1 class="w-full py-2 text-white text-center etxt-md xl:text-lg">&copy;2021 Tandifat. All Rights Reserved</h1>
</div>
<script>
    function setup() {
        return {

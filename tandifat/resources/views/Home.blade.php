        ...
        <div class="carousel-inner relative overflow-hidden w-full">
            ...
            <div class="carousel-item absolute opacity-0 ">
                <div class="relative">
                    ...
                    <div
                        class="h-full absolute top-0  w-full text-white text-sm md:text-5xl text-left flex flex-col justify-center items-start rtl:pr-48 ltr:pl-20 ltr:md:pl-48 rtl:md:pr-48">
            ...
            <label for="carousel-3"
                ...
                <svg class="absolute left-1/2 top-1/2 transform -translate-y-1/2 rtl:translate-x-1/2 -translate-x-1/2" width="11"
                ...
                <div class="owl-carousel carousel1">
                    <div class="flex flex-col justify-between items-stretch pro-item overflow-hidden">
                        ...
                        <div class="paddings">
                            ...
                            <h1
                                class="text-sm mt-1  cursor-pointer text-primary flex rtl:flex-row-reverse justify-between items-center w-6/12 md:w-6/12 relative left-1/2 transform -translate-x-1/2 ">
                                View Details
...
<div class="footer px-2 md:px-16 grid grid-cols-12 gap-2 pb-8 w-full pt-48 md:pt-36"
    style="background: url({{asset('imgs/footer.png')}});background-size:cover">
    <div class="col-span-12 md:col-span-4 flex flex-col justify-start items-start">
        <img src="{{asset('imgs/footerlogo.png')}}" class="w-72" alt="">
        <p class="text-white text-center md:rtl:text-right md:ltr:text-left text-sm -mt-4 leading-8" style="font-weight: 100">
    ...
    <div class="col-span-12 md:col-span-5 text-white pr-0 md:pr-12 pl-0 md:pl-12 flex flex-col justify-between items-start flex-wrap mt-12 md:mt-28 ">
        <div class="grid grid-cols-12 w-full">
            <div class="col-span-6 flex flex-col justify-between items-start">
                <h1 class="text-sm md:text-md font-normal"><span class="mr-6 text-2xl">></span> {{__('front.About')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Return Policy')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Seller Policy')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Cookies Policy')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Affiliate Partner')}}</h1>
            </div>
            <div class="col-span-6 flex flex-col justify-between items-start">
                <h1 class="text-sm md:text-md font-normal"><span class="mr-6 text-2xl">></span> {{__('front.Our Blog')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Terms & conditions')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Support')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Privacy Policy')}}</h1>
                <h1 class="text-sm md:text-md font-normal mt-5"><span class="mr-6 text-2xl">></span> {{__('front.Work With US')}}</h1>
            </div>
        </div>


    </div>
    <div class="col-span-12 md:col-span-3 flex flex-col justify-start items-center md:items-start  pt-24">
        <h3 class="text-white text-center text-md font-bold">
            {{__('front.Subscribe our Newsletter')}}
        </h3>
        <p class="text-white text-center md:rtl:text-right md:ltr:text-left font-light mt-2" style="font-size: 10px">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Risus
            malesuada pulvinar ultrices cursus nunc. Sed phasellus
            vestibulum sapien orci metus rhoncus quisque.
        </p>
        <div class="relative w-9/12 md:w-full mt-4">
            <input type="text" class="bg-white rounded-full h-8 w-full md:w-full pl-6" placeholder="Your Email">
        ...
        <div class="w-9/12 md:w-full flex justify-between items-center mt-4">
        ...
        <div class="w-9/12 md:w-full mt-4 flex justify-between items-center">
...
<div class="copyright w-full py-1 bg-carousel flex justify-center items-center">
    <h1 class="w-full py-2 text-white text-center etxt-md md:text-lg">&copy;{{__('front.2021 Tandifat. All Rights Reserved')}}</h1>
</div>
<script>
    function setup() {
        return {
